...
```bash
   export DEFAULT_LLM_API_KEY="sk-c4ef256a97ec496da2e36467fc11ab87"
   export DEFAULT_LLM_BASE_URL="https://platform.deepseek.com"  
   export DEFAULT_LLM_MODEL_NAME="deepseek-chat"  
```
```bash
   # create a .env file
